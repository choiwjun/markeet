...
/**
 * 랜딩페이지 히어로 섹션 - design.html 스타일 적용
 */
  ...
  return (
    <section className={`relative overflow-hidden ${className || ''}`} aria-labelledby="hero-title">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        {/* 파티클 효과 */}
        <div className="particle w-2 h-2 bg-blue-400 left-[15%] top-[30%] blur-[1px]" />
        <div className="particle w-1.5 h-1.5 bg-indigo-300 left-[25%] top-[20%]" />
        <div className="particle w-3 h-3 bg-primary/20 left-[85%] top-[15%] blur-[2px]" />
        <div className="particle w-1 h-1 bg-blue-500 left-[80%] top-[40%]" />
        <div className="particle w-2.5 h-2.5 bg-blue-200 left-[10%] top-[60%] blur-[1px]" />
      ...
      <div className="relative z-10 pt-20 pb-24 lg:pt-32 lg:pb-36">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <h1 id="hero-title" className="mx-auto max-w-5xl text-5xl font-extrabold leading-[1.2] tracking-tight text-text-main sm:text-6xl lg:text-7xl mb-8">
            엑셀 지옥은 이제 끝, <br className="hidden sm:block" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-24 relative z-20">
            <Link
              href="/signup"
              className="h-14 px-10 rounded-xl bg-gradient-to-r from-primary to-primary-light text-white text-base font-bold shadow-glow hover:shadow-glow-intense hover:-translate-y-1 transition-all w-full sm:w-auto flex items-center justify-center gap-2 ring-2 ring-primary/20 ring-offset-2"
            >
              무료 체험하기
          ...
          {/* 통계 */}
          <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 pt-12 border-t border-gray-200">
            {STATS.map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="text-3xl lg:text-4xl font-bold text-text-main mb-2">{stat.value}</div>
